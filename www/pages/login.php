...
<body>
    ...
    <div class="max-w-md mx-auto">
        ...
        <a href="register.php" class="block text-center text-gray-600 mt-4 hover:text-gray-800">Pas encore de compte? <span class="text-red-500 hover:text-red-700">Inscrivez-vous</span></a>
    </div>
</body>